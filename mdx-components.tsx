...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: (props) => <h1 className="mt-4 text-2xl font-semibold tracking-tight text-chalk" {...props} />,
    h2: (props) => (
      <h2 className="mt-12 text-lg font-semibold tracking-tight text-chalk" {...props} />
    ),
